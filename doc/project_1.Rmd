...
These all seem characteristic for what you imagine when you hear philosophy. A larger discussion of time, or nature or the world as a whole. Trying to find reason and form in a feeling of randomness. Of the top 15 words, God is noticeably on the list. 


![Nietzsche's favorite line that God is dead](../figs/god_is_dead_question.jpg)


This author, one of the many featured in this data exploration, marked a turning point for many. In this period, the way of explaining how the world functioned no longer needed an eternal, uncomprehendible god. 
...
More importantly, not only does the trend line push downwards, the tonality around these words changes as well. For example, Leibniz at the top of the graph writes:
...
whereas Niche and Marx later are writing in a very different tone.
...
We can confirm this suspicion by looking at the use of reasoning terms over time. The use of reasoning has actually remained rather constant. This we can use similarly to a baseline of reasoning. 

For this analysis, the following terms were separated and their frequency in the documents were shown as a comparison: 
